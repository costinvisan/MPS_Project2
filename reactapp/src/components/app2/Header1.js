...
import RoomResponse1 from './RoomResponse1';
...
{/* 
                                ...
                                <li className="nav-item">
                                    <Link to='/roomStatus'><div id="tab5" onClick={this.changeActive} className={(this.state.activeTab === "tab5") ? "active nav-link" : "nav-link"}>ROOM STATUS</div></Link>
                                </li>
                            </ul>
                    ...
                    <Route exact strict path='/roomStatus' component={RoomResponse1}/>
                    
                    <Route exact strict path='/allreservations' component={ReservationResponse}/>
