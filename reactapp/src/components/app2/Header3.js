...
import AllUsers3 from './AllUsers3';
import ReservationResponse3 from './ReservationResponse3';
import RoomResponse3 from './RoomResponse3';
        ...
        return(
            <div>
                ...
                <Router>
                    ...
                    <Route exact strict path='/allpatients' component={AllUsers3}/>
                    <Route exact strict path='/roomStatus' component={RoomResponse3}/>
                    <Route exact strict path='/allreservations' component={ReservationResponse3}/>
