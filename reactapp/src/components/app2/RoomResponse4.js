...
import Header4ocupat from './Header4ocupat';
...
var totalResults= 0;
var stare = 5;
class RoomResponse4 extends Component{
    ...
    async componentDidMount() {
        ...
        let response = await getRoom("id_0004");
     ...
     checkData(){
          ...
          if (n == 0) {
            ...
            console.log(this.state.rooms.status);
              console.log("+++++++++++++++busy");
              stare = 1;
          }
            if(this.state.rooms){
